...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
		<a class="navbar-brand" href="index.html">Edit Course Details</a>
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="dropdown01">
						<a class="dropdown-item" href="AddCourse.jsp">Add</a>
						<a class="dropdown-item" href="EditCourse.jsp">Edit</a>
						<a class="dropdown-item" href="courses">View All</a>
					</div></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="dropdown01"
					...
					<div class="form-group row">
						...
						<div class="col-lg-3">
							<input type="text" class="form-control" id="courseCode"
								name="courseCode" placeholder="New course code">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-3">
							<input type="text" class="form-control" id="courseName"
								name="courseName" placeholder="New course name">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-3">
							<input type="text" class="form-control" id="courseDesc"
								name="courseDesc" placeholder="New course description">
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-lg-3">
							<button type="button" class="btn btn-info"
								onclick="return validateCourseFields();submitCourseForm();">Edit Course</button>
						</div>
					</div>
